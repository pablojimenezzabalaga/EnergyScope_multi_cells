...
## Network exchanges
subject to capacity_limit_imp {c1 in REGIONS, c2 in REGIONS, i in EXCHANGE_NETWORK_R diff EXCHANGE_FREIGHT_R, h in HOURS, td in TYPICAL_DAYS} :
	Exch_imp[c1,c2,i,h,td] <= sum{n in NETWORK_TYPE[i]} Transfer_capacity [c2,c1,i,n];
subject to capacity_limit_exp {c1 in REGIONS, c2 in REGIONS, i in EXCHANGE_NETWORK_R diff EXCHANGE_FREIGHT_R, h in HOURS, td in TYPICAL_DAYS} :
...
subject to freight_of_exchanges_border{c1 in REGIONS, c2 in REGIONS} :
	Exch_freight_border[c1,c2] = (dist[c1,c2] * sum{r in EXCHANGE_FREIGHT_R diff EXCHANGE_NETWORK_R, t in PERIODS, h in HOUR_OF_PERIOD[t], td in TYPICAL_DAY_OF_PERIOD[t]}((Exch_imp[c1,c2,r,h,td] + Exch_exp[c1,c2,r,h,td])/lhv[r])) + (dist[c1,c2] * sum{r in EXCHANGE_FREIGHT_R inter EXCHANGE_NETWORK_R, n in NETWORK_TYPE[r], t in PERIODS, h in HOUR_OF_PERIOD[t], td in TYPICAL_DAY_OF_PERIOD[t]: (Exch_imp[c1,c2,r,h,td] - sum{n in NETWORK_TYPE[r]} Transfer_capacity [c2,c1,r,n]) > 0}((Exch_imp[c1,c2,r,h,td] - sum{n in NETWORK_TYPE[r]} Transfer_capacity [c2,c1,r,n])/lhv[r])) + (dist[c1,c2] * sum{r in EXCHANGE_FREIGHT_R inter EXCHANGE_NETWORK_R, n in NETWORK_TYPE[r], t in PERIODS, h in HOUR_OF_PERIOD[t], td in TYPICAL_DAY_OF_PERIOD[t]: (Exch_exp[c1,c2,r,h,td] - sum{n in NETWORK_TYPE[r]} Transfer_capacity [c1,c2,r,n]) > 0}((Exch_exp[c1,c2,r,h,td] - sum{n in NETWORK_TYPE[r]} Transfer_capacity [c1,c2,r,n])/lhv[r]));
