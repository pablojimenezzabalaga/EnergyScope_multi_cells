...
bo_country_code = ['BN', 'BN-IT', 'BN-YC', 'CB', 'CH', 'LP', 'OR',
            'PA-NA', 'PT', 'SC', 'SC-AS', 'SC-CC', 'SC-CQ',
            'SC-GB', 'SC-MI', 'SC-VC', 'SC-VL', 'TJ', 'TJ-BE',
            'TJ-EP', 'TJ-OC']
bo_full_names = ['Beni', 'Sistema Iténez', 'Sistema Yacuma', 'Cochabamba', 'Chuquisaca', 'La Paz', 'Oruro',
                 ...
                 'Sistema El Puente', 'Sistema Entre Ríos']
